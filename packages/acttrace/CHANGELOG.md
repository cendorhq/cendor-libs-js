...
- 00930d6: A chain now names the format it implements and the library that opened it.
...
- 311e22b: **Two live `AuditLog`s on one chain file are now refused instead of silently corrupting it.**
