...
leaders responsible for enforcement **confidentially through GitHub Private Vulnerability Reporting**:
[open a report](https://github.com/cendorhq/cendor-libs-js/security/advisories/new) from this
repository's **Security** tab → **Report a vulnerability**. It opens a private report only the
maintainers can see. Any `cendorhq` repository works if you would rather not use this one. All
complaints will be reviewed and investigated promptly and fairly. Community leaders are obligated to
